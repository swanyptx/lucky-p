...
const BasicSection = ({ title, text, image, reverse, sectionName, button, buttonContent = "", href = "/" }) => {
    ...
    return (
        <section className={`${section} flex justify-center items-center lg:py-20 py-10`}>
            <div className={reverse ? `container lg:flex-row flex-col flex lg:flex-row-reverse justify-between items-center lg:py-8 ` : `container flex justify-center items-center lg:py-8 grid lg:grid-cols-2 sm:grid-cols-1`}>
